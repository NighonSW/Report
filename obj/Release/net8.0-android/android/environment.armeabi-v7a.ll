...
@dso_cache = dso_local local_unnamed_addr global [546 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 98102033, ; hash 0x5d8eb11, from name: Report.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 197516337, ; hash 0xbc5dc31, from name: libaot-CsvHelper.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 356025578, ; hash 0x153884ea, from name: Report
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Report.dll.so
		ptr null; void* handle (0x0)
	}, ; 44
	...
	%struct.DSOCacheEntry {
		i64 898440345, ; hash 0x358d1c99, from name: CsvHelper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CsvHelper.dll.so
		ptr null; void* handle (0x0)
	}, ; 108
	...
	%struct.DSOCacheEntry {
		i64 1236466219, ; hash 0x49b2fa2b, from name: aot-Report.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Report.dll.so
		ptr null; void* handle (0x0)
	}, ; 146
	...
	%struct.DSOCacheEntry {
		i64 1279703294, ; hash 0x4c46b8fe, from name: libaot-Report
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Report.dll.so
		ptr null; void* handle (0x0)
	}, ; 152
	...
	%struct.DSOCacheEntry {
		i64 1869778321, ; hash 0x6f728d91, from name: libaot-CsvHelper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CsvHelper.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 2279572518, ; hash 0x87df8426, from name: aot-Report
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Report.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 2570863850, ; hash 0x993c44ea, from name: aot-CsvHelper
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CsvHelper.dll.so
		ptr null; void* handle (0x0)
	}, ; 329
	...
	%struct.DSOCacheEntry {
		i64 3190079053, ; hash 0xbe24be4d, from name: libaot-Report.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Report.dll.so
		ptr null; void* handle (0x0)
	}, ; 424
	...
	%struct.DSOCacheEntry {
		i64 3283089215, ; hash 0xc3aff73f, from name: CsvHelper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CsvHelper.dll.so
		ptr null; void* handle (0x0)
	}, ; 434
	...
	%struct.DSOCacheEntry {
		i64 3673414265, ; hash 0xdaf3da79, from name: aot-CsvHelper.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CsvHelper.dll.so
		ptr null; void* handle (0x0)
	}, ; 475
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [121 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
